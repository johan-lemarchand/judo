 ...
 */
final class Version20200427222751 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article ADD file VARCHAR(255) DEFAULT NULL, ADD user VARCHAR(255) DEFAULT NULL, DROP user_id, DROP image_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article ADD user_id INT DEFAULT NULL, ADD image_id INT DEFAULT NULL, DROP file, DROP user');
